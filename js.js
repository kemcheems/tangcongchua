...
const questions = [
    ...
    { q: "Tớ là gì ", a: ["Cây thông", "Người eo", "Gà rán"], c: 1 },
    ...
    q.a.forEach((opt, i) => {
        ...
        btn.onclick = () => {
            if (i === q.c) {
                ...
                alert("Sai rồi! Cậu bị thoát ra ngoài vì trả lời sai. Thử lại từ đầu nhé!");
                resetApp();
            }
        };
...
function submitPin() {
    if (enteredPin === correctPin) {
        // --- PHÁT NHẠC KHI ĐĂNG NHẬP THÀNH CÔNG ---
        const music = document.getElementById('bg-music');
        music.play().catch(e => console.log("Trình duyệt yêu cầu tương tác để phát nhạc"));
